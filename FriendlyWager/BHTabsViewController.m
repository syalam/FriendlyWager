...
- (id)initWithViewControllers:(NSArray *)theViewControllers style:(BHTabStyle *)theStyle tabIndex:(NSUInteger)tabIndex {
    self = [super initWithNibName:nil bundle:nil];
...
- (void)loadView {
    ...
    if (userSelected) {
        [self _makeTabViewCurrent:[self.tabsContainerView.tabViews objectAtIndex:currentTabIndex]];
    }
    else {
